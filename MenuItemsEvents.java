/* write a java application program to create a frame with menus*/
import java.awt.*;
import java.applet.*;
import java.awt.event.*;
/* <applet code = "MenuItemsEvents"width = 400 height = 200>
</applet>
*/
class MenuFrame extends Frame implements ActionListener,ItemListener,WindowListener
{
	MenuItemsEvents mie;
	MenuFrame(String title,MenuItemsEvents mie)
	{
		super(title);
		this.mie = mie;
	...
	public class MenuItemsEvents extends Applet
	{
		TextArea ta;
		public void init()
		{
